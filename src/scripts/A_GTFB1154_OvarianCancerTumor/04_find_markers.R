...
sample <- "A_GTFB1154_OvarianCancerTumor"
cell_types <- "SCT_celltype"
celltype2 <- "Spatial_celltype"
...
#   seurat_data <- FindSpatiallyVariableFeatures(seurat_data,
#                                                assay = seurat_assay,
#                                                features = VariableFeatures(seurat_data)[1:1000],
#                                                selection.method = "markvariogram",
#                                                verbose = TRUE)
#   top.features <- SpatiallyVariableFeatures(seurat_data,
#                                             selection.method = "markvariogram")[1:6]
#   
#   pdf(file.path(save_dir, "images", "spatial_features.pdf"))
#   print(SpatialFeaturePlot(seurat_data, features = top.features,
